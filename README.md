...
GetGeminiResponseTests: A unittest.TestCase class that uses unittest.mock to patch all genai functions (GenerativeModel, upload_file, etc.) to test the success and failure (e.g., FAILED state) paths of get_gemini_response.
